...
(function() {
	...
	var suggested3 = suggested[Math.floor(Math.random() * suggested.length)];
	document.getElementById("suggested3").innerHTML =
		...
		'<h4 class="f-regular" style="position: absolute; top: 0%; left: 8%; color: white">' + suggested3.name + '</h4>' +  //Name of place
		'<div style="padding: 9px">' +  //Open DIV for Information underneath
		'<div style="overflow: hidden; height: 160px; position: relative">\ ' +
		'<p class="f-regular">' + suggested3.info + '</p>' +
		'<div class="fadeout"></div>' +
		'</div>' +
		'<i class="fas fa-map-marker-alt" id="r-colour2"></i> <a>' + suggested3.location + '</a>' +  //Location
		'</div>' +  //Close DIV
